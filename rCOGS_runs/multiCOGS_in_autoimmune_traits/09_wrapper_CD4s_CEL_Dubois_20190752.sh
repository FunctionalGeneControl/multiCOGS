...
DIR=~/HRJ_monocytes/hILCs/rCOGS_in/CEL_Dubois_20190752
########################################################################

############ PARENT FOLDER WHERE COGS OUTPUT FILES SHOULD GO ###########
COGS_OUT=~/HRJ_monocytes/hILCs/COGS_results/COGS_out/CEL_Dubois_20190752
########################################################################

################### NAME FOR THE OUTPUT FILES - THE EXPERIMENT SETTINGS ##################
MYNAME=CEL_Dubois_20190752_CD4_SuSIE
##########################################################################################
...
SUSIE=~/HRJ_monocytes/external_data/gwas/SuSIE/CEL_Dubois_20190752_1-hg38.csv
###########################################################################
...
cd ${DIR}/COGS_input_${MYNAME}
cp ${DIR}/COGS_input_CEL_Dubois_20190752_ILC3_SuSIE/coding.format.txt ./
