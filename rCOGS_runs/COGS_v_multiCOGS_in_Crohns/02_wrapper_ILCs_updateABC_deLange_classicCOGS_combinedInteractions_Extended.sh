...
MYNAME=revision_CD_deLange_ILCs_hg38_ClassicCOGS_combinedInteractions_ALL_extended_ABC023
##########################################################################################

############ LOCATION OF THE (MODIFIED) PM, SUITABLE FOR COGS INPUT ######################
PM_MOD=${DIR}/peakmatrices/ILC3_chicago_fres_bin_5kb_abc_023_fres_extended_peakm_13012025_modified.txt
##########################################################################################
...
### CHECK THE PATHS IN THE COMMANDS, BUT PROBABLY FROM HEREON DO NOT NEED CHANGING.
