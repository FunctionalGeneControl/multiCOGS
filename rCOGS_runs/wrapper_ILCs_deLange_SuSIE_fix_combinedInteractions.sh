...
INDIR=${DIR}/prelim_files_deLange_ILCs_hg38_SuSIE_fix_combinedInteractions
OUTDIR=${DIR}/COGS_input_deLange_ILCs_hg38_SuSIE_fix_combinedInteractions

### Our new interaction PM uses frag res, 5kb and ABC interactions.

source activate DT_DPLYR
cd $SCRIPTS
# note, the gwas supplied here is just a filler. will run VEP etc on the SNPs in the susie data.
...
./run_vep.sh \
        ...
        -a GRCh38 \
        -m posVCF \
        -p ~/external_data/gwas/SuSIE/cd_for_mikhail_sites_SuSIE_fix_HRJ.txt \
        -o ${OUTDIR}
conda deactivate
...
Rscript ${SCRIPTS}/run_Mikhails_rCOGS.R \
        ...
        --cogsIn ${OUTDIR} \
        --assembly GRCh38 \
        --cogsOut ~/COGS_results/COGS_out/CD_deLange_ILCs_hg38_SuSIE_combinedInteractions_ALL \
        --vProm 5 \
        --susie \
...
Rscript ${SCRIPTS}/run_Mikhails_rCOGS.R \
        ...
        --cogsIn ${OUTDIR} \
        --assembly GRCh38 \
        --cogsOut ~/COGS_results/COGS_out/CD_deLange_ILCs_hg38_SuSIE_combinedInteractions_5KbOnly \
        --vProm 5 \
        --susie \
        --gwas ~/external_data/gwas/SuSIE/cd_for_mikhail_SuSIE_fix.csv \
...
Rscript ${SCRIPTS}/run_Mikhails_rCOGS.R \
        ...
        --cogsIn ${OUTDIR} \
        --assembly GRCh38 \
        --cogsOut ~/COGS_results/COGS_out/CD_deLange_ILCs_hg38_SuSIE_combinedInteractions_fresOnly \
        --vProm 5 \
        --susie \
        --gwas ~/external_data/gwas/SuSIE/cd_for_mikhail_SuSIE_fix.csv \
...
Rscript ${SCRIPTS}/run_Mikhails_rCOGS.R \
        ...
        --cogsIn ${OUTDIR} \
        --assembly GRCh38 \
        --cogsOut ~/COGS_results/COGS_out/CD_deLange_ILCs_hg38_SuSIE_combinedInteractions_ABCOnly \
        --vProm 5 \
        --susie \
        --gwas ~/external_data/gwas/SuSIE/cd_for_mikhail_SuSIE_fix.csv \
...
Rscript ${SCRIPTS}/run_Mikhails_rCOGS.R \
        ...
        --cogsIn ${OUTDIR} \
        --assembly GRCh38 \
        --cogsOut ~/COGS_results/COGS_out/CD_deLange_ILCs_hg38_SuSIE_combinedInteractions_VProm_coding_only \
        --vProm 5 \
        --susie \
        --gwas ~/external_data/gwas/SuSIE/cd_for_mikhail_SuSIE_fix.csv \
