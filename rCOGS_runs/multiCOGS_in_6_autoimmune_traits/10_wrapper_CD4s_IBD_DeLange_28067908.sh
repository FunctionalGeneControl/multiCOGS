...
DIR=~/HRJ_monocytes/hILCs/rCOGS_in/IBD_DeLange_28067908
########################################################################

############ PARENT FOLDER WHERE COGS OUTPUT FILES SHOULD GO ###########
COGS_OUT=~/HRJ_monocytes/hILCs/COGS_results/COGS_out/IBD_DeLange_28067908
########################################################################

################### NAME FOR THE OUTPUT FILES - THE EXPERIMENT SETTINGS ##################
MYNAME=IBD_DeLange_28067908_CD4_SuSIE
##########################################################################################
...
SUSIE=~/HRJ_monocytes/external_data/gwas/SuSIE/IBD_DeLange_28067908_1-hg38.csv
###########################################################################
...
cd ${DIR}/COGS_input_${MYNAME}
cp ${DIR}/COGS_input_IBD_DeLange_28067908_ILC3_SuSIE/coding.format.txt ./
