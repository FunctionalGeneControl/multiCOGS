...
DIR=~/HRJ_monocytes/hILCs/rCOGS_in/ASTAO_Ferreira_30929738
########################################################################

############ PARENT FOLDER WHERE COGS OUTPUT FILES SHOULD GO ###########
COGS_OUT=~/HRJ_monocytes/hILCs/COGS_results/COGS_out/ASTAO_Ferreira_30929738
########################################################################

################### NAME FOR THE OUTPUT FILES - THE EXPERIMENT SETTINGS ##################
MYNAME=ASTAO_Ferreira_30929738_CD4_SuSIE
##########################################################################################
...
SUSIE=~/HRJ_monocytes/external_data/gwas/SuSIE/ASTAO_Ferreira_30929738_1-hg38.csv
###########################################################################

#################### N CASES AND CONTROLS FOR THE GWAS ###################
# https://www.ebi.ac.uk/gwas/studies/GCST007799
NCASES=26582
NCONTROLS=300671
##########################################################################
...
### We can copy paste the coding SNPs from the ASTAO file previously run using the ILC3 pipeline.
...
cd ${DIR}/COGS_input_${MYNAME}
cp ${DIR}/COGS_input_ASTAO_Ferreira_30929738_ILC3_SuSIE/coding.format.txt ./
