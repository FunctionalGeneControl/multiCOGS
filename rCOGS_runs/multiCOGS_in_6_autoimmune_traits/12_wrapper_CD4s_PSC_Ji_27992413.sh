...
DIR=~/HRJ_monocytes/hILCs/rCOGS_in/PSC_Ji_27992413
########################################################################

############ PARENT FOLDER WHERE COGS OUTPUT FILES SHOULD GO ###########
COGS_OUT=~/HRJ_monocytes/hILCs/COGS_results/COGS_out/PSC_Ji_27992413
########################################################################

################### NAME FOR THE OUTPUT FILES - THE EXPERIMENT SETTINGS ##################
MYNAME=PSC_Ji_27992413_CD4_SuSIE
##########################################################################################
...
SUSIE=~/HRJ_monocytes/external_data/gwas/SuSIE/PSC_Ji_27992413_1-hg38.tsv
###########################################################################
...
cd ${DIR}/COGS_input_${MYNAME}
cp ${DIR}/COGS_input_PSC_Ji_27992413_ILC3_SuSIE/coding.format.txt ./
